...
//! different block cipher and padding modes.
//!
...
pub enum PaddingMode {
    ...
    /// Otherwise, an error is returned during encryption of the last
    /// block.
    None,
}
...
pub enum UnpaddingMode {
    ...
    /// an error is returned during decryption of the last block.
    None,
}
